...
void Servo::Setup(uint8_t pwm_channel, uint8_t pin, double t_low, double t_high , double servo_hz, int32_t pwm_freq_hz, int32_t pwm_req_bits , int32_t max_angle ){
